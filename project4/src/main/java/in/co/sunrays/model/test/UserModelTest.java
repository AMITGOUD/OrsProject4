...
public class UserModelTest {
    ...
    public static void testAdd() throws ParseException,
        ...
        try {
            ...
            //bean.setId(21L);
            bean.setFirstName("pro");
            bean.setLastName("student");
            bean.setLogin("student@gmail.com");
            bean.setPassword("pass1234");
            bean.setDob(new Timestamp(new Date().getTime()));
            bean.setMobileNo("7999714095");
            bean.setRoleId(1L);
            ...
            bean.setLastLoginIP(ip.toString());
            bean.setModifiedBy("amit");
            bean.setCreatedDatetime(new Timestamp(new Date().getTime()));
            bean.setModifiedDatetime(new Timestamp(new Date().getTime()));
            bean.setRegisteredIP(ip.toString());
            
            model.add(bean);
            
			/*
			 * UserBean addedbean = model.findByPK(pk);
			 * System.out.println("Test add succ"); if (addedbean == null) {
 ...
 * 
 * try { UserBean bean = new UserBean(); long pk = 0L; bean.setId(pk);
 * model.delete(bean); System.out.println("Test Delete succ" + bean.getId());
 * UserBean deletedbean = model.findByPK(pk); if (deletedbean == null) {
 ...
 * 
 * try { UserBean bean = model.findByPK(1L); bean.setFirstName("cmc limited");
 * bean.setLastName("pvt ltd"); bean.setLogin("ranjitchoudhary210@gmail.com");
 ...
 *//**
	 ...
	 */
/*
 * public static void testFindByPK() { try { UserBean bean = new UserBean();
 * long pk = 1L; bean = model.findByPK(pk); if (bean == null) {
 ...
 *//**
	 ...
	 */
/*
 * public static void testFindByLogin() { try { UserBean bean = new UserBean();
 * bean = model.findByLogin("545"); if (bean == null) {
 * System.out.println("Test Find By PK fail"); }
 * System.out.println(bean.getId()); System.out.println(bean.getFirstName());
 * System.out.println(bean.getLastName()); System.out.println(bean.getLogin());
 * System.out.println(bean.getPassword()); System.out.println(bean.getDob());
 ...
 * 
 * try { UserBean bean = new UserBean(); List list = new ArrayList();
 * bean.setRoleId(2L); list = model.getRoles(bean); if (list.size() < 0) {
 * System.out.println("Test Get Roles fail"); } Iterator it = list.iterator();
 * while (it.hasNext()) { bean = (UserBean) it.next();
 * System.out.println(bean.getId()); System.out.println(bean.getFirstName());
 * System.out.println(bean.getLastName()); System.out.println(bean.getLogin());
 * System.out.println(bean.getPassword()); System.out.println(bean.getDob());
 * System.out.println(bean.getRoleId());
 ...
 * 
 * try { UserBean bean = new UserBean(); List list = new ArrayList();
 * bean.setFirstName("ranjeet"); list = model.search(bean, 0, 0); if
 * (list.size() < 0) { System.out.println("Test Serach fail"); } Iterator it =
 * list.iterator(); while (it.hasNext()) { bean = (UserBean) it.next();
 * System.out.println(bean.getId()); System.out.println(bean.getFirstName());
 * System.out.println(bean.getLastName()); System.out.println(bean.getLogin());
 * System.out.println(bean.getPassword()); System.out.println(bean.getDob());
 * System.out.println(bean.getRoleId());
 ...
 * 
 * try { UserBean bean = new UserBean(); bean.setLogin("kumar@g.com");
 * bean.setPassword("rr"); bean = model.authenticate(bean.getLogin(),
 * bean.getPassword()); if (bean != null) {
 * System.out.println("Successfully login");
 * 
 * } else { System.out.println("Invalied login Id & password"); }
 * 
 * } catch (ApplicationException e) { e.printStackTrace(); } }
 * 
 *//**
 ...
 * 
 * // bean.setId(8L); bean.setFirstName("vipin"); //
 * bean.setLastName("kumawat"); bean.setLogin("rranjitch11ou1dhay@gmail.com");
 * bean.setPassword("rr"); bean.setConfirmPassword("4444");
 * bean.setDob(sdf.parse("11/20/2015")); bean.setGender("Male");
 * bean.setRoleId(2); long pk = model.registerUser(bean);
