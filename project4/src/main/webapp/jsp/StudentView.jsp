...
<%@include file="Header.jsp" %>
	...
	<%if(bean.getId()>0){ %>
            <h1 style="margin-left: 15.5em">Update Student</h1><%}else{ %>
            <h1 style="margin-left: 15.5em">Add Student</h1><%} %>
...
<tr>
			...
			<tr>
				...
				<td><input type="text" name="email"
					...
					<%=(bean.getId() > 0) ? "readonly" : ""%>></td><td><font color="red"><%=ServletUtility.getErrorMessage("email", request)%></font></td>
			</tr>
			<tr>
